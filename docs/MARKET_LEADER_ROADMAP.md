...
## Phase R2 — Compliance moat: productised AML *(blocked on partner creds)*
...
These are what make Engage *the* leader, not a catch-up.
...
| Proposal → signed → *recurring* conversion | n/a | track from R1 |
