...
| 1.6 | 🔶 `any` burn-down (289): auth … Clara AI + proposal workflow API typed (`types/auth.ts` … `types/proposals.ts`)                                           | Typed seams catch integration drift at compile time                                    | tsc strict; count tracked in CI log                                                                                                                | M (rolling) | NEXT  |
