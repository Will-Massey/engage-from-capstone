...
| 4.4 | ⬜ Cache pass: catalogue/templates-meta/ai-status responses (memory cache exists, unused in hot paths); CF worker cache headers for static assets | Cheap latency wins, fewer DB hits                          | Cache-hit assertions; header checks in e2e                                     | S–M    | LATER |
