...
| 1.2 | 🔶 **Frontend test foundation**: vitest for auth store, api interceptors, builder actions, public signing (45 seam tests; 62 total frontend)               | Every UI regression currently rides on 8 smoke specs                                   | Vitest + testing-library for: auth store, api interceptors (CSRF/refresh), ProposalBuilderContext actions (the 97-field core), public signing page | M           | NOW   |
...
| 1.6 | ✅ `any` burn-down: `api.ts` client methods typed (`types/auth.ts` … `types/firmGroup.ts`)                                                                 | Typed seams catch integration drift at compile time                                    | tsc strict; apiClient surface fully typed                                                                                                          | M (rolling) | NEXT  |
...
_2026-07-07 (w1/testing-wave-2): money-path branches (decline, share revoke, approval reject + senior denial); `workflow-journeys.spec.ts` (renewals, agency isolation, reject queue); routeAuthz expanded; vitest for authStore, proposalBuilderDraft, decline reasons; auth API client typed._

_2026-07-07 (w1/proposals-types-vitest): `types/proposals.ts` + typed create/update/get/accept API methods; `proposalBuilderActions.ts` extracted from context; 11 vitest tests for validation, save payload, and service-line actions._

_2026-07-07 (w1/clients-types-public-signing-vitest): `types/clients.ts` + typed get/create/update/MTD ITSA API methods; `publicSigning.ts` extracted from ProposalView; 11 vitest tests for signing steps, validation, and sign payload._

_2026-07-08 (w1/services-types-interceptors-vitest): `types/services.ts` + typed list/get/create/update/duplicate/delete API methods; api interceptor vitest expanded to 16 (response unwrap, public-page CSRF/redirect, CSRF hydration, network errors)._

_2026-07-08 (w1/tenant-settings-types): `types/tenants.ts` + typed create/check-subdomain/onboarding/settings/proposal-terms/webhook API methods._

_2026-07-08 (w1/pricing-ai-types): `types/pricing.ts` + typed suggest-fees/explain/contingent-fee/pricing-advisor API methods; pricing suggestion storage consolidated on shared types._

_2026-07-08 (w1/touchpoints-automation-types): `types/touchpoints.ts` + `types/automation.ts` + typed template/approval/engine/client-touchpoint and automation settings API methods._

_2026-07-08 (w1/payout-settings-types): extended `types/payment.ts` with payout update/ledger/agreements types; typed get/put payout settings, ledger, and agreements API methods._

_2026-07-08 (w1/clara-ai-types): `types/ai.ts` + typed Clara AI status, suggest/draft/revise, email stream, client brief, auto-fit, attention queue, regulatory alerts, and voice-proposal API methods._

_2026-07-08 (w1/proposal-workflow-types): extended `types/proposals.ts` with renewal, approval, send/withdraw/lost, terms preview, activity, audit trail, signatures, and regulatory-fit types; typed proposal workflow API methods._

_2026-07-08 (w1/payments-billing-types): extended `types/payment.ts` with Stripe/billing config, subscription CRUD, and setup-intent types; typed platform payments/billing API methods._

_2026-07-08 (w1/templates-types): `types/templates.ts` + typed cover-letter template CRUD/preview/merge-fields and proposal template list/detail/CRUD/from-proposal API methods._

_2026-07-08 (w1/engagement-library-types): `types/engagementLibrary.ts` + typed engagement library versions, publish, quarterly schedule/release, and templates-needing-update API methods._

_2026-07-08 (w1/companies-house-types): `types/companiesHouse.ts` + typed Companies House status/search/company lookup and client enrich/snapshot API methods._

_2026-07-08 (w1/remaining-api-types): `types/aml.ts`, `types/clientLifecycle.ts`, `types/analytics.ts`, `types/integrations.ts`, `types/firmGroup.ts` + typed AML/regulatory/onboarding, client lifecycle, analytics, Xero/QuickBooks, and firm-group API methods — completes `apiClient` §1.6 burn-down._
