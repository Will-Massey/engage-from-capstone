# Engage — Landing Page Copy

**URL:** `capstonesoftware.co.uk/engage`  
**Product:** Engage by Capstone — UK accountancy proposal platform  
...
1. **Look up your client** — Companies House enrichment fills company details automatically.
2. **Clara drafts the proposal** — Services, pricing, cover letter, and engagement terms — you approve every section.
3. **Send and sign** — Branded client link, mobile signing, automated reminders, and post-sign onboarding.
...
- Named in our launch case studies (optional)
...
- Service catalog with CSV bulk import
...
- Clara pricing advisor (flags below-floor fees)
...
- Automated reminders: unopened 3d, unsigned 7d, expiring 30d
...
- Signature certificate PDF appended to signed proposal
...
- Cloudflare email webhooks (bounce / open tracking)
...
**Is Engage only for proposals?**  
Yes — we're proposal-first. Deeper practice management stays in AccountFlow, Xero, or your existing stack.

**Does Clara send emails without my approval?**  
Never. Clara drafts; you approve every client-facing email before it goes out.

**Is the e-sign legally defensible in the UK?**  
Engage records simple electronic signatures with full forensic metadata. Enterprise tier will offer qualified e-sign (DocuSign) for firms that require it.

**Can I import my service catalog?**  
Yes — CSV bulk import is available on all tiers.

---

## Footer CTA

**Ready to send your first proposal today?**
