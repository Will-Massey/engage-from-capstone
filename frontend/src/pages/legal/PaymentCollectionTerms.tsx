    ...
    <LegalPageLayout title="Payment Collection Terms" lastUpdated="4 July 2026">
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            Capstone acts as a commercial collection agent — not as the provider of professional
            services to your client.
          </li>
          <li>
            You are responsible for the accuracy of fees, scope, and client communications in
            proposals sent through Engage.
          </li>
          <li>
            You must only enable payment collection where you are permitted to do so under your
            professional body rules and UK law.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          If a client payment is reversed, refunded, or charged back, we may recover the amount
          (including fees) from future payouts or invoice your practice directly.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          You may disable payment collection at any time in Engage settings. Outstanding collected
          funds will be paid out subject to holds and chargeback windows. Transaction records are
          retained for at least seven years for audit purposes.
        </p>
      </section>
    </LegalPageLayout>
  );
