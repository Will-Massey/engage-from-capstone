  ...
  return (
    <div className="glass-tile p-4">
      ...
      <button
        type="button"
        onClick={onLogout}
        className="mt-3 flex items-center w-full px-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-100/50 dark:hover:bg-slate-800/50 rounded-lg transition-colors"
      >
