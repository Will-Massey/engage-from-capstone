...
exports.findDemoTenant = findDemoTenant;
exports.seedServicesForTenant = seedServicesForTenant;
...
router.post('/seed-services', auth_js_1.authenticate, (0, errorHandler_js_1.asyncHandler)(async (req, res) => {
