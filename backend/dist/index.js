...
Promise.resolve().then(() => __importStar(require('./scripts/autoMigrateOnStartup.js'))).then((mod) => {
    autoMigrateOnStartup = mod.default;
})
    .catch(() => {
    logger_js_1.default.warn('Auto-migration module not available');
});
...
app.get('/api/seed-services-public', async (req, res) => {
    ...
    try {
        ...
        if (existingCount > 0) {
            const servicesToFix = await database_js_2.prisma.serviceTemplate.findMany({ where: { tenantId: tenant.id } });
            let fixed = 0;
            for (const s of servicesToFix) {
                ...
                if (s.billingCycle !== correctBillingCycle || s.priceAmount !== correctPrice) {
                    await database_js_2.prisma.serviceTemplate.update({
                        where: { id: s.id },
        ...
        const servicesData = [
            ...
            },
            {
                ...
                description: 'Monthly service for annual Confirmation Statement filing with Companies House.',
            ...
            },
            {
                ...
                description: 'Monthly service covering preparation and submission of personal Self Assessment tax returns.',
            ...
            },
            {
                ...
                description: 'Monthly VAT return preparation, Making Tax Digital (MTD) submission, and ongoing VAT advisory.',
            ...
            },
            {
                ...
                description: 'Monthly service for P11D forms preparation and submission for directors and employees.',
            ...
            },
            {
                ...
                description: 'Monthly service for professional registered office address with Companies House and HMRC correspondence handling.',
