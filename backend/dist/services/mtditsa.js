...
class MTDITSAService {
     ...
     */
    static calculateStatus(annualIncome, incomeSources, options = {}) {
        const triggeredBy = [];
     ...
     */
    static checkExemptions(options, incomeSources) {
     ...
     */
    static calculateQuarterlyDeadlines(taxYear) {
     ...
     */
    static getSoftwareRecommendations() {
        return [
            {
                name: 'Xero',
