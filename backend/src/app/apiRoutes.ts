...
import publicPracticeLettersRoutes from '../routes/publicPracticeLetters.js';
...
export function mountApiRoutes(app: express.Express): void {
  ...
  app.use('/api/public/practice-letters', publicPracticeLettersRoutes);
  ...
  app.use('/api/comms', extractTenant, commsRoutes);
  app.use('/api/forms', extractTenant, formsRoutes);
