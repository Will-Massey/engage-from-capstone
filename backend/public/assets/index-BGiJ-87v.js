...
var m = 'clover',
  ...
  w = ''.concat(S, '/').concat(m, '/stripe.js'),
  b = /^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,
  g = /^https:\/\/js\.stripe\.com\/(v3|[a-z]+)\/stripe\.js(\?.*)?$/;
var L = function (r) {
    return b.test(r) || g.test(r);
  },
  j = function () {
    for (
      var r = document.querySelectorAll('script[src^="'.concat(S, '"]')), e = 0;
      e < r.length;
      e++
    ) {
      var n = r[e];
  ...
  R = function (r, e) {
    !r ||
      !r._registerWrapper ||
      r._registerWrapper({ name: 'stripe-js', version: '8.11.0', startTime: e });
  },
  a = null,
  c = null,
  l = null,
  P = function (r) {
    return function (e) {
      r(new Error('Failed to load Stripe.js', { cause: e }));
    };
  },
  T = function (r, e) {
    return function () {
  ...
  I = function (r, e, n) {
    ...
    if (typeof t != 'string')
      throw new Error(
        'Expected publishable key to be of type string, got type '.concat(p(t), ' instead.')
      );
    var i = t.match(/^pk_test/),
      u = h(r.version),
      d = m;
    i &&
      u !== d &&
...
export { _ as loadStripe };
//# sourceMappingURL=index-BGiJ-87v.js.map
