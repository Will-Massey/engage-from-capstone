...
async function main() {
  ...
  const servicesData = [
    // COMPLIANCE SERVICES
    {
      ...
      longDescription:
        'Comprehensive preparation of your annual statutory accounts in accordance with UK GAAP or FRS 102, including all necessary disclosures and notes.',
      basePrice: 750,
      baseHours: 5,
  ...
  for (const proposal of proposalsData) {
    const created = await prisma.proposal.create({
      data: {
        ...
        subtotalPence: proposal.subtotal * 100,
        discountAmountPence: proposal.discount * 100,
        vatAmountPence: proposal.vat * 100,
        totalPence: proposal.total * 100,
      ...
      proposal.services.map((svc) =>
        prisma.proposalService.create({
          data: {
            ...
            lineTotalPence: svc.qty * svc.price * 100,
            frequency: 'MONTHLY',
          },
        })
      )
