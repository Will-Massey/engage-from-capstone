/**
 * UK Accountancy Services Seed
 * Production-ready service catalog for Engage by Capstone
...
We will also advise on steps to prevent future late filing and can set up a compliance calendar for your business.`,
      basePrice: 1200,
      baseHours: 8,
      pricingModel: 'FIXED',
...
We file your return online before the 31 January deadline, calculate your tax liability, and advise on payment on account requirements and any tax planning opportunities.`,
      basePrice: 295,
      baseHours: 2.5,
      pricingModel: 'FIXED',
      frequencyOptions: 'ANNUALLY',
...
We also advise on partial exemption calculations, EU/NI trade post-Brexit, reverse charge mechanisms for construction services (CIS), and domestic reverse charge for VAT.`,
      basePrice: 175,
      baseHours: 2,
      pricingModel: 'FIXED',
...
We ensure your records are kept digitally, your quarterly obligations are met, and your tax position is reviewed proactively throughout the year.`,
      basePrice: 120,
      baseHours: 1,
      pricingModel: 'FIXED',
...
We also provide tailored advice on allowable expenses, capital allowances, and property income allowances to optimise your tax position under MTD ITSA.`,
      basePrice: 120,
      baseHours: 1,
      pricingModel: 'FIXED',
      frequencyOptions: 'QUARTERLY',
...
We also prepare the P11D(b) return, calculate Class 1A National Insurance Contributions, and advise on payrolling of benefits as an alternative to P11D reporting.`,
      basePrice: 45,
      baseHours: 0.5,
...
We submit Full Payment Submissions (FPS) on or before each payday and Employer Payment Summaries (EPS) where required. Year-end services include P60 production and P11D preparation if applicable.`,
      basePrice: 22,
      baseHours: 0.3,
      pricingModel: 'PER_EMPLOYEE',
...
We also handle leaver processing (P45s), new starter declarations, and year-end reconciliations. Ideal for retail, hospitality, construction, and seasonal businesses.`,
      basePrice: 28,
      baseHours: 0.4,
      pricingModel: 'PER_EMPLOYEE',
...
We also handle re-enrolment every three years, opt-out and opt-in processing, and compliance with minimum contribution rates (currently 8% total, with at least 3% employer).`,
      basePrice: 12,
      baseHours: 0.2,
      pricingModel: 'PER_EMPLOYEE',
      frequencyOptions: 'MONTHLY',
...
We work with leading cloud accounting software including Xero, QuickBooks, Sage, and FreeAgent, and can provide you with real-time dashboards and cash flow visibility.`,
      basePrice: 395,
      baseHours: 4,
      pricingModel: 'FIXED',
      frequencyOptions: 'MONTHLY',
...
We also liaise with Xero support on your behalf for technical issues and can recommend add-on apps to streamline your workflows.`,
      basePrice: 75,
      baseHours: 0.5,
      pricingModel: 'FIXED',
      frequencyOptions: 'MONTHLY',
...
We configure Dext to handle VAT splits, foreign currency invoices, and mileage claims, ensuring your bookkeeping is as efficient and paperless as possible.`,
      basePrice: 350,
      baseHours: 2,
      pricingModel: 'FIXED',
      frequencyOptions: 'ONE_TIME',
