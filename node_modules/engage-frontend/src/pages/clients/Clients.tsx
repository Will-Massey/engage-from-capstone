        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <p className="mt-1 text-orange-100">
              Clients with income over £50,000 must be ready for Making Tax Digital.
              Review your clients and ensure they're prepared.
            </p>
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex items-start justify-between">
                ...
                {client.mtditsaEligible && (
                  <span className="badge badge-orange text-xs">MTD ITSA</span>
                )}
              </div>
